<%-- 
    Document   : register
    Created on : 05/08/2017, 12:31:32 AM
        ...
        <div class="alert fade in">
         ...
         <div class="alert alert-block alert-error fade in">
            ...
            <div class="control-group">
                <label class="contact"><strong>Username</strong><sup>*</sup></label>
                <div class="controls">
                 <s:input path="username" cssClass="contact_input" placeholders="usuario"></s:input>
                </div>
            </div>    
            <div class="control-group">
                <label class="contact"><strong>Password</strong><sup>*</sup></label>
                <div class="controls">
                    <s:password path="password" cssClass="contact_input"></s:password>
                </div>
            </div>
            <div class="control-group">
                <label class="contact"><strong>Full Name<sup>*</sup></label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="contact"><strong>Email<sup>*</sup></label>
                <div class="controls">
